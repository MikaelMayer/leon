...
object LinearEquations {
  ...
  /** Computes a list of solution of the equation c1*x1 + ... + cn*xn where coef = [c1 ... cn]
  ...
  /** @param as The parameters
    * @param xs The variables for which we want to find one satisfiable assignment
    * @param equation The equation between the parameters and the variables.
  ...
  /** Returns a particular solution to t + c1x + c2y = 0, with (pre, (x0, y0)) */
  ...
  /** Returns a particular solution of a normalized integer equation.
